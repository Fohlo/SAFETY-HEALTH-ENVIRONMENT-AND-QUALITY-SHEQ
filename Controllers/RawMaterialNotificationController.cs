...
namespace PROPLASTICSAPI.Controllers
{
    ...
    [ApiController]
    public class RawMaterialNotificationController : Controller
    {
        [HttpGet]
        public ErrorMDL Get(string session, int Doc)
        {
            try
            {
                ...
                return new ErrorMDL { Success = JsonConvert.SerializeObject(RawMaterialNotificationBLL.get(session, Doc)) };
            }
            catch (Exception ex)
            {
                return new ErrorMDL
        ...
        public ErrorMDL Get(string session)
        {
            try
            {
                ...
                return new ErrorMDL { Success = JsonConvert.SerializeObject(RawMaterialNotificationBLL.get(session, query)) };
            }
            catch (Exception ex)
            {
                return new ErrorMDL
        ...
        [HttpPost]
        public ErrorMDL Post(string session, PostRMNMDL data)
        {
            try
            {
                SessionBLL.ValidateAppSession(session);
                return new ErrorMDL { Success = JsonConvert.SerializeObject(RawMaterialNotificationBLL.Post(session, data)) };
            }
            catch (Exception ex)
            {
                return new ErrorMDL
        ...
        [HttpPost]
        [Route("Update")]
        public ErrorMDL Post(string session, int Doc, PatchRMNMDL data)
        {
            try
            {
                SessionBLL.ValidateAppSession(session);
                return new ErrorMDL { Success = JsonConvert.SerializeObject(RawMaterialNotificationBLL.Patch(session, data, Doc)) };
            }
            catch (Exception ex)
            {
                return new ErrorMDL
