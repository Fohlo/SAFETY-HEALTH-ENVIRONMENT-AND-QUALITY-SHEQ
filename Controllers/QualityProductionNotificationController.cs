...
namespace PROPLASTICSAPI.Controllers
{
    ...
    [ApiController]
    public class QualityProductionNotificationController : Controller
    {
        [HttpGet]
        public ErrorMDL Get(string session, int Doc)
        {
            try
            {
                ...
                return new ErrorMDL { Success = JsonConvert.SerializeObject(QualityProductionNotificationBLL.get(session, Doc)) };
            }
            catch (Exception ex)
            {
                return new ErrorMDL
        ...
        public ErrorMDL Get(string session)
        {
            try
            {
                ...
                return new ErrorMDL { Success = JsonConvert.SerializeObject(QualityProductionNotificationBLL.get(session, query)) };
            }
            catch (Exception ex)
            {
                return new ErrorMDL
        ...
        [HttpPost]
        public ErrorMDL Post(string session, PostPNMDL data)
        {
            try
            {
                SessionBLL.ValidateAppSession(session);
                return new ErrorMDL { Success = JsonConvert.SerializeObject(QualityProductionNotificationBLL.Post(session, data)) };
            }
            catch (Exception ex)
            {
                return new ErrorMDL
        ...
        [HttpPost]
        [Route("Update")]
        public ErrorMDL Post(string session, int Doc, PatchPNMDL data)
        {
            try
            {
                SessionBLL.ValidateAppSession(session);
                return new ErrorMDL { Success = JsonConvert.SerializeObject(QualityProductionNotificationBLL.Patch(session, data, Doc)) };
            }
            catch (Exception ex)
            {
                return new ErrorMDL
        ...
        [HttpGet]
        [Route("GetByProductionOrderNumber")]
        public ErrorMDL NatureOfInd(string session, string NatureOfInd)
        {
            try
            {
                SessionBLL.ValidateAppSession(session);
                var query = "ACCIDENTRPT?$filter = U_PONo eq '" + NatureOfInd + "'";
                return new ErrorMDL { Success = JsonConvert.SerializeObject(QualityProductionNotificationBLL.get(session, query)) };
            }
            catch (Exception ex)
            {
        ...
        public ErrorMDL Department(string session, string Department)
        {
            ...
            {
                SessionBLL.ValidateAppSession(session);
                var query = "ACCIDENTRPT?$filter = U_ProdMaterial eq '" + Department + "'";
                return new ErrorMDL { Success = JsonConvert.SerializeObject(QualityProductionNotificationBLL.get(session, query)) };
            }
            catch (Exception ex)
            {
